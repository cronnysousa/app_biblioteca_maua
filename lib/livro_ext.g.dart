...
part of 'livro_ext.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

LivroExt _$livro_extFromJson(Map<String, dynamic> json) => LivroExt(
      json['id'] as int,
...
Map<String, dynamic> _$livro_extToJson(LivroExt instance) => <String, dynamic>{
      'id': instance.id,
